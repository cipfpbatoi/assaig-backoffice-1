...
<body>
<h4>Editado de la Fecha {{ $date->fecha }}</h4>
<form action="{{ route('fecha.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="fecha">Fecha</label>
        <input type="date" name="fecha" id="facha" class="form-control" value="{{ $date->fecha}}">
        @if ($errors->has('fecha'))
    ...
    <div class="form-group">
        ...
        <input type="number" name="pax" id="pax" class="form-control" value="{{ $date->pax }}">
        @if ($errors->has('pax'))
            <div class="text-danger">
                {{ $errors->first('pax') }}
            </div>
    ...
    <div class="form-group">
        ...
        <input type="number" name="overbooking" id="overbooking" class="form-control" value="{{ $date->overbooking }}">
    ...
    <div class="form-group">
        ...
        <input type="number" name="pax_espera" id="pax_espera" class="form-control" value="{{ $date->pax_espera }}">
    ...
    <div class="form-group">
        ...
        <input type="time" name="horario_apertura" id="horario_apertura" class="form-control" value="{{ $date->horario_apertura }}">
    ...
    <div class="form-group">
        ...
        <input type="time" name="horario_cierre" id="horario_cierre" class="form-control" value="{{ $date->horario_cierre }}">
